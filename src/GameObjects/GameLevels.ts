        ...
        { // 1
            ...
            props: {
                question:
                    `
Привет 👋
Тебе будет даваться вопрос, на который нужно выбрать верный ответ, либо ввести ответ в поле (зависит от типа вопроса). На каждый вопрос дается ${Globals.MAX_ATTEMPTS} попытки. После получения ответа, наведи на иконку информации для объяснения ответа, если необходимо
